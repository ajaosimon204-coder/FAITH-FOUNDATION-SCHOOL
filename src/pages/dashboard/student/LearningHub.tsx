...
export default function LearningHub() {
  ...
  return (
    <div className="space-y-8 font-sans pb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {lectures.length === 0 ? (
              <div className="col-span-1 md:col-span-2 text-center py-12 space-y-3">
                <div className="text-3xl">📚</div>
                <p className="text-xs font-black uppercase text-slate-800 tracking-wider">No learning materials have been uploaded yet.</p>
                <p className="text-[10px] text-slate-450 max-w-xs mx-auto font-semibold leading-relaxed">Please consult your subject teacher or class administrator to fetch latest curriculum documents.</p>
              </div>
            ) : (
              lectures.map((lec) => (
      ...
      {activeTab === 'syllabus' && (
        <div className="bg-white rounded-3xl border border-slate-200 p-6 md:p-8 space-y-6 shadow-sm">
          <h3 className="text-sm font-black text-slate-800 uppercase tracking-wider border-b border-slate-105 pb-3">Alpha Core Science Curriculum Coverage</h3>
